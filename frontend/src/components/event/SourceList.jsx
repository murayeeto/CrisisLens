  ...
  return (
    <div className="space-y-2">
      {sources.map((source, idx) => {
        const name = source.name || source.outlet || 'Source'
        const url = source.url || '#'
        const outlet = source.outlet || name
        return (
          <a
            key={source.id || idx}
            href={url}
